-- Update user_profiles view to include guest_count from members table
-- This makes the guest_count accessible through the API
...
SELECT 
    ...
    m.guest_count, -- Add guest_count from members table
    t.id as trainer_id,
    t.specialization,
    t.experience_years,
    t.bio,
...
COMMENT ON VIEW user_profiles IS 'View that joins accounts, profiles, members, and trainers tables using the correct foreign key relationships. Includes guest_count from members table.';
