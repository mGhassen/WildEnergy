-- Fix functions to use category_groups junction table instead of categories.group_id
-- This migration updates the existing functions to work with the many-to-many relationship
...
-- Update refund_group_session function
