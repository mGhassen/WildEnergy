-- Add created_at column to user_profiles view
-- This adds the account creation timestamp to the user_profiles view for use in admin dashboard
...
SELECT 
    ...
    a.last_login,
    a.is_admin,
    a.created_at, -- Add account creation timestamp
    p.first_name,
    p.last_name,
    p.phone,
...
COMMENT ON VIEW user_profiles IS 'View that joins accounts, profiles, members, and trainers tables using the correct foreign key relationships. Includes created_at from accounts table.';
