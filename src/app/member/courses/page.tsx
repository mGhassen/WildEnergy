...
function MemberCourses() {
  ...
  useEffect(() => {
    ...
    if (err && typeof err === "object" && "type" in err && (err as any).type === "OVERLAP") {
      ...
      router.push(`/member/courses/${courseId}/overlap?from=/member/courses`);
    }
                      ...
                      <CardContent className="p-4">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                          ...
                          <div className="flex items-center text-xs sm:text-sm text-muted-foreground">
                            <Users className="w-3 h-3 sm:w-4 sm:h-4 mr-2 text-primary flex-shrink-0" />
                            <span className="font-medium text-foreground">
                              {course.max_participants > 0 && course.current_participants >= course.max_participants ? 'Course Full' :
                            ...
                            <div className="flex gap-2">
                              ...
                              <Button
                                ...
                                onClick={() => {
                                  ...
                                  if (registration?.id) {
                                    router.push(
                                      `/member/registrations/${registration.id}/qr?from=/member/courses`,
                                    );
                                  }
                                }}
                                className="px-3"
