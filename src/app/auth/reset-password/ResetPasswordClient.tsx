...
export default function ResetPasswordClient({ searchParams }: { searchParams: Record<string, string | string[] | undefined> }) {
  ...
  // Get tokens and email from searchParams
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setTimeout(async () => {
        try {
          await login(emailFromSession || '', password);
        } catch (loginError) {
